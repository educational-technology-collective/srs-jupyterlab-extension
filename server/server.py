...
class OpenAIFlashCard:
    def __init__(self):
        openai.api_key = "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"
        self.flashcards = []
    ...
    def run(self, notebook):
        ...
        try:
            response = openai.ChatCompletion.create(
                ...
                messages=[{"role": "user",
                           "content": "The following is a a list of cells from a Jupyter notebook assignment from a data science course on the topic of regex expression. Please generate a list of flashcards in question answer format in JSON. Focus on conceptual knowledge like regex basic knowledge. "+notebook}],
            )
