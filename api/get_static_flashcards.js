...
const flashcards_a2 = [
    ...
    },
    {
        ...
        "content": {
            ...
            "answer": "To calculate the Pearson correlation coefficient between two columns in a DataFrame using Python, first import scipy.stats library. Then, use `stats.pearsonr(column_1, column_2)` function where 'column_1' and 'column_2' are the two columns of interest. The function returns the correlation coefficient and p-value."
        }
    },
    {
        "lm_id": 9,
...
const handler = async (event) => {
  ...
  if (queryParams) {
      ...
      if (param1 == 1) {
        ...
        response = {
            statusCode: 404,
            body: JSON.stringify('Assignment number not found'),
        };
      }
  }
  else {
      response = {
          statusCode: 404,
          body: JSON.stringify('No assignment number specified'),
      }
  }
